#line 1 "..\\..\\..\\..\\Library\\NUC1xx-LB_002\\Source\\TFT.c"
...
#line 4 "..\\..\\..\\..\\Library\\NUC1xx-LB_002\\Source\\TFT.c"
...
#line 5 "..\\..\\..\\..\\Library\\NUC1xx-LB_002\\Source\\TFT.c"
...
#line 6 "..\\..\\..\\..\\Library\\NUC1xx-LB_002\\Source\\TFT.c"
...
#line 7 "..\\..\\..\\..\\Library\\NUC1xx-LB_002\\Source\\TFT.c"
...
#line 8 "..\\..\\..\\..\\Library\\NUC1xx-LB_002\\Source\\TFT.c"
...
#line 9 "..\\..\\..\\..\\Library\\NUC1xx-LB_002\\Source\\TFT.c"
#line 1 "..\\..\\..\\..\\Library\\NUC1xx-LB_002\\Include\\TFT.h"
...
#line 10 "..\\..\\..\\..\\Library\\NUC1xx-LB_002\\Source\\TFT.c"
#line 1 "..\\..\\..\\..\\Library\\NUC1xx-LB_002\\Include\\TFT8x16.h"
...
#line 11 "..\\..\\..\\..\\Library\\NUC1xx-LB_002\\Source\\TFT.c"

#line 22 "..\\..\\..\\..\\Library\\NUC1xx-LB_002\\Source\\TFT.c"
...
void init_SPI3(void)
{
  ...
  DrvSPI_ClrSS(eDRVSPI_PORT3, eDRVSPI_SS0); 
}

void lcdWriteCommand(unsigned char temp)
{
	DrvGPIO_ClrBit(E_GPB, 7);
	DrvSPI_SetSS(eDRVSPI_PORT3, eDRVSPI_SS0);
...
void printC(int16_t x, int16_t y, unsigned char ascii_code)
{
 	...
 	for(i=0; i<16;i++) {		
		...
		for(j=0;j<8;j++) {
			if((m&0x80)==0x80) tftWriteData(0xFFFF);				
			else	 				     tftWriteData(0x0000);
			m<<=1;
		}	
	}
...
void draw_LCD(unsigned char *buffer)
{
	...
	for (x=0; x<128; x++) {
    	for (y=0; y<8; y++) {		
			...
			for(j=0;j<8;j++) {
				if((m&0x01)==0x01) tftWriteData(0xFFFF);				
				else	 				     tftWriteData(0x0000);
				m>>=1;
			}	
		}
