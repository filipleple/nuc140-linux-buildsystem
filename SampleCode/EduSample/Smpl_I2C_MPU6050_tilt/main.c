//
// Smpl_I2C_MPU6050_tilt : measuring tilt using 3-axis Accelerometer
//
...
int32_t main (void)
{
	...
	{									  
		...
		// calculate tilt (*57.295 = degree of angle)
		Axr = 57.295* atan(accX / sqrt(pow(accY,2)+pow(accZ,2)));		
	  Ayr = 57.295* atan(accY / sqrt(pow(accX,2)+pow(accZ,2)));
		Azr = 57.295* atan(accZ / sqrt(pow(accX,2)+pow(accY,2)));
    		// print to LCD			
