...
#line 12 "..\\main.c"
#line 1 "..\\..\\..\\..\\Library\\NUC1xx-LB_002\\Include\\SDCard.h"
...
#line 12 "..\\..\\..\\..\\Library\\NUC1xx-LB_002\\Include\\SDCard.h"
...
#line 55 "..\\..\\..\\..\\Library\\NUC1xx-LB_002\\Include\\SDCard.h"
...
#line 81 "..\\..\\..\\..\\Library\\NUC1xx-LB_002\\Include\\SDCard.h"
...
FIL file1;				 	
   ...
   put_rc(f_open(&file1, (TCHAR*)i8FileName, 0x02));
   f_lseek(&file1, count);
...
void InitADC(void)
{
	...
	((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL1.ADC_S = 0;	
	((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKDIV.ADC_N = 0;	
...
while(1)
	{
		...
		((ADC_T *) ((( uint32_t)0x40000000) + 0xE0000))->ADSR.ADF=1;
		u8FileBuff[0]=(((ADC_T *) ((( uint32_t)0x40000000) + 0xE0000))->ADDR[7].RSLT>>8)&0x0f;
		u8FileBuff[1]=(((ADC_T *) ((( uint32_t)0x40000000) + 0xE0000))->ADDR[7].RSLT>>0)&0x0f;		
		write_sdcard(i);
		if(i>(10000*2)) break;
		i=i+2;
		((ADC_T *) ((( uint32_t)0x40000000) + 0xE0000))->ADCR.ADST=1;
