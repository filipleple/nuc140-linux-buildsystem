...
#line 12 "..\\main.c"
#line 1 "..\\..\\..\\..\\Library\\NUC1xx\\Include\\I2C.h"
...
#line 10 "..\\..\\..\\..\\Library\\NUC1xx\\Include\\I2C.h"
...
#line 13 "..\\main.c"
#line 1 "..\\..\\..\\..\\Library\\NUC1xx\\Include\\I2S.h"
...
#line 10 "..\\..\\..\\..\\Library\\NUC1xx\\Include\\I2S.h"
...
#line 60 "..\\..\\..\\..\\Library\\NUC1xx\\Include\\I2S.h"
...
int16_t i16PCMBuff[504];
int16_t i16PCMBuff1[504];
uint8_t	u8FileBuff[512];
...
uint16_t PcmRecBuff[32*12] = {0};
uint32_t u32RecPos_Out = 0;
uint32_t u32RecPos_In = 0;
									
 
uint32_t PcmPlayBuff[32*12] = {0};
...
static void WAU8822_Setup(void)
{
	...
	I2C_WriteWAU8822(6,  0x1ED);    
	
	I2C_WriteWAU8822(7,  0x00A);    

	I2C_WriteWAU8822(10, 0x008);    
	I2C_WriteWAU8822(14, 0x108);    
	I2C_WriteWAU8822(15, 0x1EF);    
	I2C_WriteWAU8822(16, 0x1EF);    
		
	I2C_WriteWAU8822(43, 0x010);   

	I2C_WriteWAU8822(44, 0x000);    
	I2C_WriteWAU8822(45, 0x150);    
	I2C_WriteWAU8822(46, 0x150);    
	I2C_WriteWAU8822(47, 0x007);    
	I2C_WriteWAU8822(48, 0x007);    
...
void Tx_thresholdCallbackfn0(uint32_t status)
{
	...
	for	( i = 0; i < 4; i++)
	{
		...
		((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->I2STXFIFO = i32Data;
		if(--u32DataSize==0)
		{
...
void Rx_thresholdCallbackfn0(uint32_t status)
{
	...
	for	( i = 0; i < 4; i++)
	{
		i32Data=((I2S_T *) ((( uint32_t)0x40100000) + 0xA0000))->I2SRXFIFO>>16;
...
void InitWAU8822(void)
{
    ...
    st.u8WordWidth 	 	 = 0x01;
    st.u8AudioFormat 	 = 0x00;  		
	st.u8DataFormat  	 = 0x00;   
    st.u8Mode 		 	 = 0x01;
    st.u8TxFIFOThreshold = 0x04;
    st.u8RxFIFOThreshold = 0x04;
...
int32_t UAC_MainProcess(void)
{
	...
	put_rc(f_open(&file1, (TCHAR*)i8FileName, 0x01));
	u32FileBuffPointer=512;
	f_lseek(&file1,0);
	put_rc(f_read(&file1, u8FileBuff, u32FileBuffPointer, &u32FileBuffPointer));
	while(u32FileBuffPointer!=512);
	...
	{		
		...
		while(1)
		{
			if(u32PCMBuffPointer>=504)
			{
				u32FileBuffPointer=512;
				put_rc(f_read(&file1, u8FileBuff, u32FileBuffPointer, &u32FileBuffPointer));
				AdpcmDec4(u8FileBuff,(short*)i16PCMBuff,504);
				u32PCMBuffPointer=0;
			}
			if(u32PCMBuffPointer1>=504)
			{
				AdpcmDec4(u8FileBuff+(504/2+4),(short*)i16PCMBuff1,504);
