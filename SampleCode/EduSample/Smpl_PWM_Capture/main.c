//
// Smpl_PWM_Capture : using Capture0 to capture PWM1 & PWM2 output
//
// GPA12 / Capture0 : input (to connect one of the outputs)
// GPA13 / PWM1     : output
// GPA13 / PWM2     : output
...
int32_t main (void)
{
	...
	print_Line(0, "Capture demo");
	print_Line(1, ">>GPA12");
	 
	while(1)
	{
		sprintf(adc_value,"High:           ");
		print_Line(2, adc_value);
