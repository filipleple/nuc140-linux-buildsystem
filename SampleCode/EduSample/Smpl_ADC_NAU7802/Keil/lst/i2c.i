#line 1 "..\\..\\..\\..\\Library\\NUC1xx\\Source\\I2C.c"
...
#line 7 "..\\..\\..\\..\\Library\\NUC1xx\\Source\\I2C.c"
...
#line 8 "..\\..\\..\\..\\Library\\NUC1xx\\Source\\I2C.c"
#line 1 "..\\I2C_setup.h"

#line 9 "..\\..\\..\\..\\Library\\NUC1xx\\Source\\I2C.c"

#line 17 "..\\..\\..\\..\\Library\\NUC1xx\\Source\\I2C.c"

#line 25 "..\\..\\..\\..\\Library\\NUC1xx\\Source\\I2C.c"
...
void I2C_Write(uint8_t INDEX,uint8_t DATA)
{
	...
	((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->I2CDAT = 0xA6;
  DrvI2C_Ctrl(I2C_PORT1, 0, 0, 1, 0);   
  while(((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->I2CON . SI==0);	

	
	((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->I2CDAT = INDEX;	
	DrvI2C_Ctrl(I2C_PORT1,0, 0, 1, 0);   
	while(((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->I2CON . SI==0);	
...
uint8_t I2C_Read(uint8_t INDEX)
{
  ...
  DrvI2C_Ctrl(I2C_PORT1,1, 0, 1, 0);	
	...
	((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->I2CDAT = (0xA6+1);
  DrvI2C_Ctrl(I2C_PORT1,0, 0, 1, 0);	
  while(((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))->I2CON . SI==0);	
