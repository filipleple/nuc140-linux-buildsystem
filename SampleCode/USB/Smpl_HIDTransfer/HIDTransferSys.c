...
{
	{DrvUSB_CtrlDataInAck, 	 &g_HID_sDevice},	/* ctrl pipe0 */
...
int32_t HID_Open(void *pfGetInReport, void *pfSetOutReport)
{
	...
	psDevice->device = (void *)DrvUSB_InstallClassDevice(&sHIDClass);
	...
	DrvUSB_InstallCtrlHandler(psDevice->device, g_asCtrlCallbackEntry, 
